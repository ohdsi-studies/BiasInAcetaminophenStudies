...
generateReport <- function(outputFolder) {
  fileName <- file.path(outputFolder, "BiasInAcetaminophenStudiesReport.docx")
  rmarkdown::render(system.file("rmarkdown", "report.Rmd", package = "BiasInAcetaminophenStudies"),
