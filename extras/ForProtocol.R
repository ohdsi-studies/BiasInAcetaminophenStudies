...
mdrrs <- BiasInAcetaminophenStudies:::addCohortNames(mdrrs, IdColumnName = "outcomeId", nameColumnName = "outcomeName")
...
pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "BiasInAcetaminophenStudies")
